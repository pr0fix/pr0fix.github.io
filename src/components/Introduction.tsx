const Introduction: React.FC = () => {
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center gap-10 mt-16 px-6 max-w-6xl mx-auto">
      <div className="flex-1 max-w-[650px]">
        ...
        <p className="text-lg md:text-xl leading-relaxed text-gray-700 font-medium">
          ...
          with background in web development and a Bachelor's in Information
